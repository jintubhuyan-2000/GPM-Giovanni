# =============================================================================
# NASA GIOVANNI AREA-AVERAGED TIME SERIES GUI
# =============================================================================
#
# FEATURES
# --------
# 1. Earthdata username/password entered through GUI
# 2. Earthdata authentication using earthaccess
# 3. Product dropdown with variable selection
# 4. Variable dropdown automatically changes with product
# 5. KML/KMZ upload for ROI
# 6. Automatic polygon extraction from KML/KMZ
# 7. Automatic latitude/longitude extent extraction
# 8. Automatic centroid calculation
# 9. Automatic grid generation
# 10. Cosine latitude weighting
# 11. Polygon coverage weighting
# 12. Giovanni point time-series queries
# 13. Parallel API requests
# 14. Half-hourly, Hourly, Daily output
# 15. Plots for all temporal resolutions
# 16. ROI/Grid plot
# 17. Excel output with multiple sheets
# 18. Statistics generation
# 19. Progress bar with status updates
# 20. Log output window
# 21. Results tab with file listing
# 22. Single point data extraction
# 23. Daily accumulated spatial maps
#
# =============================================================================
...
class GiovanniGUI:
    ...
    def process(self):
        try:
            ...
            if mode == "single_point":
                ...
                self.update_status("Generating spatial grid...", 10)
                self.log_message("Generating spatial grid...")
            ...
            if mode == "area_average" and self.create_spatial_maps.get():
                self.update_status("Creating daily spatial maps...", 96)
                self.log_message("Creating daily spatial maps...")
    ...
    def create_daily_spatial_maps(self, raw_data, points, output_dir):
        ...
        try:
            ...
            self.log_message(f"Creating {len(unique_dates)} daily spatial maps...")
            ...
            for i, date in enumerate(unique_dates):
                ...
                self.update_status(f"Creating spatial maps: {i+1}/{len(unique_dates)}", progress)
